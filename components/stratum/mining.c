...
void prepare_bm_job_template_with_version_masks_into(bm_job *job, const mining_notify *params,
                                                     uint32_t submit_version_mask,
                                                     ...
                                                     uint32_t difficulty)
{
    ...
    asic_version_mask &= submit_version_mask;

    job->version = params->version & ~submit_version_mask;
    job->version_mask = asic_version_mask;
    job->submit_version_mask = submit_version_mask;
    job->host_version_mask = submit_version_mask & ~asic_version_mask;
    job->host_version_bits = 0;
                                        ...
                                        uint8_t intended_chip_id)
{
    ...
    *job = *job_template;
    ...
    job->version |= host_version_bits;
    job->host_version_bits = host_version_bits;
    job->intended_chip_id = intended_chip_id;
