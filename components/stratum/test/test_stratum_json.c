...
{
    const char *fractional_json = "{\"id\":null,\"method\":\"mining.set_difficulty\",\"params\":[1647.4206230108975]}";
    const char *integer_json = "{\"id\":null,\"method\":\"mining.set_difficulty\",\"params\":[1638]}";
    StratumApiV1Message stratum_api_v1_message = {};
    STRATUM_V1_parse(&stratum_api_v1_message, fractional_json);
    TEST_ASSERT_EQUAL(MINING_SET_DIFFICULTY, stratum_api_v1_message.method);
    TEST_ASSERT_EQUAL(1647, stratum_api_v1_message.new_difficulty);
    TEST_ASSERT_DOUBLE_WITHIN(1e-12,
                              1647.4206230108975,
                              stratum_api_v1_message.new_difficulty_value);

    STRATUM_V1_parse(&stratum_api_v1_message, integer_json);
    TEST_ASSERT_EQUAL(MINING_SET_DIFFICULTY, stratum_api_v1_message.method);
