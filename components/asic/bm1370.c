...
#define BM1370_JOB_ID_STEP 0x10
#define BM1370_JOB_SLOT_MASK 0x70
...
static uint8_t id = BM1370_JOB_SLOT_MASK;
...
task_result * BM1370_process_work(void * pvParameters)
{
    ...
    uint8_t job_id = asic_result.job_id & BM1370_JOB_SLOT_MASK;
