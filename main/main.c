...
void app_main(void)
{
    ...
    ASIC_set_job_difficulty_mask(&GLOBAL_STATE, GLOBAL_STATE.stratum_difficulty);
    ...
    rc = xTaskCreatePinnedToCore(ASIC_result_task, "asic result", 4096, (void *)&GLOBAL_STATE, 12, NULL, 1);
